...
_ENCODERS = {
    ...
    "resnet50": (build_segnet_resnet50, freeze_resnet_encoder, unfreeze_resnet_encoder),
}
...
def main() -> None:
    ...
    if args.encoder == "resnet50" and args.encoder_weights is None:
        raise SystemExit(
            "--encoder=resnet50 requires --encoder-weights pointing to "
            "the output of scripts/convert_encoder_weights.py."
        )
